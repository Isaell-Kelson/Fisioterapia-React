    ...
    return (
        <section className="map-section flex flex-col items-center p-5" id={mapId}>
            <div className="map-section__header text-center mb-5">
                ...
                <h3 className="map-section__subtitle text-xl text-gray-600 mb-24">Região onde nossos serviços alcançam</h3>
            </div>
            <div className="map-section__content flex gap-5 w-full justify-between flex-wrap">
                ...
                <div className="map-section__text-content flex-1 max-w-[50%] min-w-[300px] flex items-center">
                    <p className="map-section__description text-base text-gray-700 leading-6 text-justify m-0 p-2 bg-gray-50 border-2 border-teal-300 rounded">
                        Nossos serviços de fisioterapia pediátrica estão disponíveis em Recife e região, oferecendo cuidados
                        especializados para crianças de todas as idades. Nossa equipe é altamente qualificada para tratar uma ampla gama
                        de condições, desde problemas de desenvolvimento motor até lesões e reabilitação. Com um ambiente acolhedor e
                        equipamentos de ponta, garantimos que cada sessão seja eficaz e agradável para seus pequenos. Entre em contato
